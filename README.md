...
The ASV (generated by DADA2 after denoising) are by default being classified with VSEARCH alignment against the SILVA-138 database (Ref NR 99; i.e. non-redundant 99% identity), which is a 16S rRNA gene sequences reference database for taxonomic classification. This is part of the _"classify-consensus-vsearch”_ [QIIME2 feature classifier module](https://amplicon-docs.qiime2.org/en/latest/references/plugins/feature-classifier.html#q2-action-feature-classifier-classify-consensus-vsearch).

If you wish to use other classification methods, (pre-trained/custom) classifiers and/or databases, have a look at the QIIME2 documentation and change the path to the classifier in the metaTAXONx `nextflow.config` configuration file.
